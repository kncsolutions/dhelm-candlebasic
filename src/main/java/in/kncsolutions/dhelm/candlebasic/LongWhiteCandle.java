 ...
 */
 ...
 /**
 *According to literature a long white candle is made of white body, i.e closing
 ...
 *is long white candle or not.   
 */
 
 public class LongWhiteCandle{
   ...
   private boolean isLongWhiteCandle;
  ...
  */
   public LongWhiteCandle(List<Double> open,List<Double> high,List<Double> low,List<Double> close, int numBody , int numLen, double percentage) throws DataException{
     Open.addAll(open);
	 High.addAll(high);
	 Low.addAll(low);
	 Close.addAll(close);
   ...
   *
   */
   private void LongWhiteCandle()throws DataException{
   ...
   */
   public boolean isLongWhiteCandle(){
     return isLongWhiteCandle;
   }
