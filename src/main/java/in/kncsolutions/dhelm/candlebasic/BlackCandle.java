 ...
 */
 ...
 /**
 *According to litarature a  Black candle is made of Black body, i.e closing
   ...
   private void BlackCandle()throws DataException{
	   ...
	   if(Open.get(0)>Close.get(0)){         
          if((High.get(0)!=Open.get(0))&&(Low.get(0)!=Close.get(0))){
            if(((High.get(0)-Open.get(0))<(Open.get(0)-Close.get(0))) &&  ((Close.get(0)-Open.get(0))<(Open.get(0)-Close.get(0))) ){
                if((Open.get(0)-Close.get(0))<3*avgBodyLength && (High.get(0)-Low.get(0))>avgCandleLength*Percentage/100.0){
                   isBlackCandle=true; 				  
                }
            }
          }
