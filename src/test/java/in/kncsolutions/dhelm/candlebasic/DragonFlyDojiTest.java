...
/**
 * Unit test for DragonFlyDoji.class.
 */
public class DragonFlyDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   DragonFlyDoji  l=new DragonFlyDoji(open,high,low,close,25,70+i);
			   boolean isL=l.isDragonFlyDoji();
			   System.out.println("The candle is a  DragonFly Doji Candle : "+ isL);
			}
