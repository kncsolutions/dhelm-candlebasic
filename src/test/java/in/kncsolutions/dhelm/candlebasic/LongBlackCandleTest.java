...
/**
 * Unit test for LongBlackCandle.class.
 */
public class LongBlackCandleTest
{
	...
	@Test
	  public void test() {
	      ...
	      for(int i=0;i<10;i++){
			...
			try{
			  LongBlackCandle l=new LongBlackCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isLongBlackCandle();
			   System.out.println("The candle is a Long Black Candle : "+ isL);
			}
