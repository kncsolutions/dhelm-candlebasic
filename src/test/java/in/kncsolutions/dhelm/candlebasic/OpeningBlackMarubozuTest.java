...
/**
 * Unit test for OpeningBlackMarubozu.class
 */
public class OpeningBlackMarubozuTest 
{
	...
	@Test
	  public void test() {	      
	      for(int i=0;i<10;i++){
			...
			try{
			  OpeningBlackMarubozu  l=new OpeningBlackMarubozu(open,high,low,close);
			   boolean isW=l.isOpeningBlackMarubozu();
			   boolean isL=l.isLongOpeningBlackMarubozu(25,70);
			   System.out.println("The candle is a  Opening  Black Marubozu Candle : "+ isW +" Long/Short : "+isL);
			}
