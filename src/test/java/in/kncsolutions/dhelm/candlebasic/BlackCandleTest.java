...
/**
 * Unit test for BlackCandle.class.
 */
public class BlackCandleTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   BlackCandle  l=new BlackCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isBlackCandle();
			   System.out.println("The candle is a  Black Candle : "+ isL);
			}
