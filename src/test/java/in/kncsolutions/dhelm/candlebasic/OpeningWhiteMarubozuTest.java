...
/**
 * Unit test for OpeningWhiteMarubozuTest.class
 */
public class OpeningWhiteMarubozuTest 
{
	...
	@Test
	  public void test() {	      
	      for(int i=0;i<10;i++){
			...
			try{
			  OpeningWhiteMarubozu  l=new OpeningWhiteMarubozu(open,high,low,close);
			   boolean isW=l.isOpeningWhiteMarubozu();
			   boolean isL=l.isLongOpeningWhiteMarubozu(25,70);
			   System.out.println("The candle is a  Opening White Marubozu Candle : "+ isW +" Long/Short : "+isL);
			}
