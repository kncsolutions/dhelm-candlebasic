...
/**
 * Unit test for WhiteMarubozuTest.class
 */
public class WhiteMarubozuTest 
{
	...
	@Test
	  public void test() {	      
	      for(int i=0;i<10;i++){
			...
			try{
			  WhiteMarubozu  l=new WhiteMarubozu(open,high,low,close);
			   boolean isW=l.isWhiteMarubozu();
			   boolean isL=l.isLongWhiteMarubozu(25,70);
			   System.out.println("The candle is a  White Marubozu Candle : "+ isW +" Long/Short : "+isL);
			}
