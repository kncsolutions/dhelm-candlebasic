	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   Doji  l=new Doji(open,high,low,close,25,70+i);
			   boolean isD=l.isDoji();
			   boolean isL=l.isLongDoji();
			   System.out.println("The candle is a   Doji Candle : "+ isD + " Long/Short : "+isL);
			}
