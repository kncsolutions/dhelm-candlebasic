...
/**
 * Unit test for WhiteSpinningTop.class.
 */
public class WhiteSpinningTopTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			  WhiteSpinningTop  l=new WhiteSpinningTop(open,high,low,close,25,70+i);
			   boolean isW=l.isWhiteSpinningTop();
			   boolean isL=l.isLongWhiteSpinningTop();
			   System.out.println("The candle is a   White spinning top Candle : "+ isW +" Long/Short : "+isL);
			}
