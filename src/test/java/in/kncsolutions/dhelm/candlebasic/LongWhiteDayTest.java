	...
	@Test
	  public void test() {
	      ...
	      for(int i=0;i<10;i++){
			...
			try{
			  LongWhiteCandle  l=new LongWhiteCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isLongWhiteCandle();
			   System.out.println("The candle is a Long White Candle : "+ isL);
			}
