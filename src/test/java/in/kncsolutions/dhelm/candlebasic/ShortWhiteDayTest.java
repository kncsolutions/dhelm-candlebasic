 ...
 */
public class ShortWhiteDayTest 
{
	...
	@Test
	  public void test() {
	      for(int i=0;i<10;i++){
			...
			try{
			  ShortWhiteCandle  l=new ShortWhiteCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isShortWhiteCandle();
			   System.out.println("The candle is a Short White Candle : "+ isL);
			}
