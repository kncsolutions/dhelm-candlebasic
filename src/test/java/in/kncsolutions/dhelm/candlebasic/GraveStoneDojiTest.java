...
/**
 * Unit test for GraveStoneDoji.class.
 */
public class GraveStoneDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   GraveStoneDoji  l=new GraveStoneDoji(open,high,low,close,25,70+i);
			   boolean isL=l.isGraveStoneDoji();
			   System.out.println("The candle is a  Grave Stone Doji Candle : "+ isL);
			}
