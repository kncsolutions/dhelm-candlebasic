...
/**
 * Unit test for WhiteCandle.class.
 */
public class WhiteCandleTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   WhiteCandle  l=new WhiteCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isWhiteCandle();
			   System.out.println("The candle is a  White Candle : "+ isL);
			}
