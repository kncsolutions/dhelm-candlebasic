 ...
 */
public class ShortBlackDayTest 
{
	...
	@Test
	  public void test() {
	      for(int i=0;i<10;i++){
			...
			try{
			  ShortBlackCandle  l=new ShortBlackCandle(open,high,low,close,5,25,70+i);
			   boolean isL=l.isShortBlackCandle();
			   System.out.println("The candle is a Short Black Candle : "+ isL);
			}
