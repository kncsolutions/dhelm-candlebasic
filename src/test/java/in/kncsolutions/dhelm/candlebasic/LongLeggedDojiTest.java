...
/**
 * Unit test for LongLeggedDoji.class.
 */
public class LongLeggedDojiTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			   LongLeggedDoji  l=new LongLeggedDoji(open,high,low,close,25,70+i);
			   boolean isL=l.isLongLeggedDoji();
			   System.out.println("The candle is a  Long Legged Doji Candle : "+ isL);
			}
