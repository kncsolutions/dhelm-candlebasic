...
/**
 * Unit test for HighWave.class.
 */
public class HighWaveTest 
{
	...
	@Test
	  public void test() {	     
	      for(int i=0;i<10;i++){
			...
			try{
			  HighWave  l=new HighWave(open,high,low,close,25,70+i);
			   boolean isW=l.isHighWave();
			   System.out.println("The candle is a   White spinning top Candle : "+ isW );
			}
